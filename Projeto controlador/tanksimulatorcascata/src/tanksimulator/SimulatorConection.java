...
public class SimulatorConection extends Thread {
    ...
    private double erroAtualEscravo;
    private double erroAtualMestre;
    private double erroAntigo;
    private double erroAntigoEscravo;
    private double erroAntigoMestre;
    private double nivelDoTanque1Antigo;
    private double tempoInstataneo;
    private double kp, kpMestre, kpEscravo;
    private double ki, kiMestre, kiEscravo;
    private double kd, kdMestre, kdEscravo;
    private int opcaoControleSerieOuCascata[];
    //0 - controladorP
    //1 - controladorPI
    //2 - controladorPD
    //3 - controladorPID
    ...
    private ControleCascata controleCascata;
    private Controlador mestre, escravo;
    ...
    public SimulatorConection() {
        ...
        this.mestre = new Controlador();
        this.escravo = new Controlador();
    ...
    public int[] getOpcaoControleSerieOuCascata() {
        return opcaoControleSerieOuCascata;
    }

    public void setOpcaoControleSerieOuCascata(int[] opcaoControleSerieOuCascata) {
        this.opcaoControleSerieOuCascata = opcaoControleSerieOuCascata;
    }
            ...
            if (this.OnSystem) {
                ...
                if (true) {
                    if (this.isMalhaAberta()) {
                        ...
                        if (opcaoControleSerieOuCascata[0] == 0 || opcaoControleSerieOuCascata[0] == 1) {
                            this.erroAtual = (this.setpointAltura - (this.readValue[0] * alpha));
                            ...
                            if (true) {
                                ...
                                if (this.PVetor[21] < 0.5) {
                                    ...
                                    } else if (this.TypeControl == 5) {
                                        //this.controleCascata.ControleCascata(mestre, escravo, ControleCascata.opcaoControlador.ControlP, ControleCascata.opcaoControlador.ControlP, erroAtual, erroAtual, deltaT, kp, deltaT, ki, deltaT, deltaT, erroAtual, erroAtual, erroAntigo, erroAntigo, deltaT, erroAtual, setpointAltura, setpointAltura);
                                    }

                                }

                                //tanque 1
                                this.timeMensureMaster.analisarSaida(tempoS, tempoS - 0.1, this.setpointAltura, (this.readValue[0] * alpha), this.erroAtual, this.erroAntigo);
                                //System.out.println("pico acima: " + this.timeMensureMaster.getPicoParaCima());
                                //System.out.println("");
                                //System.out.println("pico abaixo: " + this.timeMensureMaster.getPicoParaBaixo());
                                //System.out.println("efetivo: " + this.timeMensureMaster.getValorEfetivo());
                                //System.out.println("overshoot: " + this.timeMensureMaster.getOvershootper());
                                //System.out.println("");
                            }

                            this.erroAntigo = this.erroAtual;
                            this.nivelDoTanque1Antigo = this.readValue[0] * alpha;

                            this.PVetor[19] = this.controlador.getAcumulado();
                            this.PVetor[20] = this.controlador.getDif();
                            if (this.valor > 3) {
                                this.valor = 3;
                            }
                            ...
                            if(numeroIteracoes % iteracoes == 0){
                                this.erroAtualMestre = (this.setpointAltura - (this.readValue[1] * alpha));
                            }
                            numeroIteracoes++;
                            ...
                            if (true) {
                              controleCascata.ControleCascata(mestre, escravo, ControleCascata.opcaoControlador.ControlP, ControleCascata.opcaoControlador.ControlP, kpMestre, kpEscravo, kiMestre, kiEscravo, kdMestre, kdEscravo, erroAtualMestre, erroAntigoMestre, erroAntigoEscravo, 0.1, 0.1, this.PVetor[22], this.PVetor[22],this.altura[0]);
                              this.valor = controleCascata.getSaidaEscravo(); 
                                //tanque 1
                                this.timeMensureMaster.analisarSaida(tempoS, tempoS - 0.1, this.setpointAltura, (this.readValue[0] * alpha), this.erroAtual, this.erroAntigo);
                                //System.out.println("pico acima: " + this.timeMensureMaster.getPicoParaCima());
                                //System.out.println("");
                    ...
                    if (!(this.altura[0] > 28.5 || this.altura[1] > 28.5)) {
                         ...
                         * else if ((this.altura[0] > 28 || this.altura[1] >
                         * 28)) { try { if (this.PVetor[18] < 1) {
                         * this.quanserClient.write(this.writeChannel, 0);
                         * this.PVetor[18] = 2;
                         *
    ...
    public void conversionSetpoint(JTextField txtF_setpoint) {
        try {
            ...
            this.PVetor[14] = this.setpointAltura;
            this.controlador.setDif(0);
            this.controlador.setAcumulado(0);
