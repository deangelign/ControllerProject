...
public class SimulatorConection extends Thread {
    ...
    private SeguidorDeRerenciaDiscreto seguidor;
    ...
    public SimulatorConection() {
        ...
        this.seguidor = new SeguidorDeRerenciaDiscreto();
    }
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (this.OnSystem) {
                ...
                if (true) {
                    if (this.isMalhaAberta()) {
                        ...
                        if (this.TipoDeControleSerieOuCascata == 2) {
                            ...
                            } else if (this.TypeControlEscravo == 1) {
                                this.valor = this.controlador.controladorPIEscravo(this.erroAtualEscravo, this.erroAntigoEscravo, this.kp_escravo, this.ki_escravo, 0.1, this.PVetor[22]);

                            } else if (this.TypeControlEscravo == 2) {
                                this.valor = this.controlador.ControladorPDEscravo(this.erroAtualEscravo, this.erroAntigoEscravo, this.kp_escravo, this.kd_escravo, 0.1);
                            } else if (this.TypeControlEscravo == 3) {
                                this.valor = this.controlador.controladorPIDEscravo(this.erroAtualEscravo, this.erroAntigoEscravo, this.kp_escravo, this.ki_escravo, this.kd_escravo, 0.1, this.PVetor[22]);
                            } else if (this.TypeControlEscravo == 4) {
                                this.valor = this.controlador.controladorPI_DEscravo(this.erroAtualEscravo, this.erroAntigoEscravo, (this.altura[0]), this.nivelDoTanque1Antigo, kp_escravo, ki_escravo, kd_escravo, 0.1, this.PVetor[22]);
                            }
                        ...
                        if (this.TipoDeControleSerieOuCascata == 3) {
                            this.PVetor[39] = 2;
                            this.erroAtual = (this.setpointAltura - (this.altura[1]));
                            this.PVetor[14] = this.setpointAltura;
                            this.PVetor[12] = this.erroAtual / alpha;
                            ...
                            this.valor = this.controlador.controladorP(this.erroAtual, 1);


                            estimador.calcularEstimacaoDoNivel(this.altura[1], valor);




                            this.PVetor[35] = estimador.getValorEstimadoDoTanque1Atual();
                            this.PVetor[36] = estimador.getValorEstimadoDoTanque2Atual();
                            //this.PVetor[37] = estimador.getErroAlturaTanque1();
                            //this.PVetor[38] = estimador.getErroAlturaTanque2();
                        }
                        
                        if(this.TipoDeControleSerieOuCascata == 4){
                            double erroSeguidor;
                            System.out.println("entrei");
                            
                            erroSeguidor = erroAtual*0.1 + seguidor.getErroAcumulado() ;
                            seguidor.setErroAcumulado(erroSeguidor);
                            
                            
                            this.seguidor.updateNiveis(altura[0], altura[1]);
                            this.seguidor.calcularKzinhos();
                            this.seguidor.calculaTensaoNaBomba();
                            this.valor = seguidor.getUk();
                ...
                //trava superior
                if ((this.altura[0] == 27 || this.altura[0] == 27) && this.valor > 1.75) {
                    this.valor = 1.75;
                    this.PVetor[4] = 2;

                } //trava de entupimento
                else if (this.altura[0] > 28 || this.altura[1] > 28) {
                    this.valor = 0;
                    this.PVetor[18] = 2;

                } //trava inferior
                else if (this.altura[0] <= 4 && this.valor < 0) {
                    this.valor = 0;
                    this.PVetor[17] = 2;
                ...
                //habilita atualização no grafico

                //envia o valor de tensão para a bomba
                if (true) {
                    try {
                ...
                tempoS = (this.tempoAtual_nano - this.tempoInicial_nano) / 1000000000.0;
                deltaT = (this.tempoAtual_nano - this.tempoInstataneo) / 1000000000.0;
