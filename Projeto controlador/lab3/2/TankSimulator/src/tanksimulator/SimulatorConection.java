...
//                        this.PVetor[13] = this.erroAtual;
                        ...
                        this.erroAtual = (this.setpointAltura - (this.readValue[1] * alpha));
                        this.PVetor[14] = this.setpointAltura;
                        this.PVetor[12] = this.erroAtual / alpha;
                        this.PVetor[13] = this.erroAtual;
                        ...
                        if (true) {
                            ...
                            if (this.PVetor[21] < 0.5) {
                                if (this.TypeControl == 0) {
                                    ...
                                    this.valor = this.controlador.controladorPI_D(this.erroAtual, this.erroAntigo, (this.readValue[1] * alpha), this.nivelDoTanque1Antigo, kp, ki, kd, 0.1, this.PVetor[22]);
                                }
                            } else {
                                ...
                                if (this.TypeControl == 0) {
                                    ...
                                    this.valor = this.controlador.controladorPI_D_time(this.erroAtual, this.erroAntigo, (this.readValue[1] * alpha), this.nivelDoTanque1Antigo, kp, ki, kd, 0.1, this.PVetor[22]);
                                }
                            ...
                            //tanque 2
                            /*if (this.readChannel[1]) {
                                this.timeMensureMaster2.analisarSaida(tempoS, tempoS - 0.1, this.setpointAltura, (this.readValue[1] * alpha), setpointAltura - (this.readValue[1] * alpha), erroAntigoTanque2);
                                erroAntigoTanque2 = setpointAltura - (this.readValue[1] * alpha);
                            }*/
