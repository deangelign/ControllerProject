            ...
            if (this.OnSystem) {
                ...
                if (true) {
                    if (this.isMalhaAberta()) {
                        ...
                        if (true) {
                            //System.out.println("acumulado: " + controlador.getAcumulado());
                            //System.out.println("Dif: " + controlador.getDif());
                            //System.out.println("erro atual: " + this.erroAtual);
                            //System.out.println("erro antigo: " + this.erroAntigo);


                            if (this.TypeControl == 0) {
                                this.valor = this.controlador.controladorP(this.erroAtual, this.kp);
                            } else if (this.TypeControl == 1) {
                                this.valor = this.controlador.controladorPI(this.erroAtual, this.erroAntigo, this.kp, this.ki, 0.2);
                            } else if (this.TypeControl == 2) {
                                this.valor = this.controlador.ControladorPD(this.erroAtual, this.erroAntigo, this.kp, this.kd, 0.2);
                            } else if (this.TypeControl == 3) {
                                this.valor = this.controlador.controladorPID(this.erroAtual, this.erroAntigo, this.kp, this.ki, this.kd, 0.2);
                            } else if (this.TypeControl == 4) {
                                this.valor = this.controlador.controladorPI_D(this.erroAtual, this.erroAntigo, (this.readValue[0] * alpha), this.nivelDoTanque1Antigo, kp, ki, kd, 0.2);
                            }
                        }
                        ...
                        //System.out.println("controle: " + TypeControl);
                    }
                }
